...
<body id="page-top" data-spy="scroll" data-target=".navbar-custom">
				...
				<div class="wow bounceInUp" data-wow-delay="0.2s">
					<div class="team boxed-grey">
						<div class="inner">
							...
							<div class="avatar">
								<img src="<%=path %>/img/team/1.jpg" alt=""
				...
				<div class="wow bounceInUp" data-wow-delay="0.5s">
					<div class="team boxed-grey">
						<div class="inner">
							...
							<div class="avatar">
								<img src="<%=path %>/img/team/2.jpg" alt=""
									class="img-responsive img-circle" />
							</div>
				...
				<div class="wow bounceInUp" data-wow-delay="0.8s">
					<div class="team boxed-grey">
						<div class="inner">
							...
							<div class="avatar">
								<img src="<%=path %>/img/team/3.jpg" alt=""
									class="img-responsive img-circle" />
							</div>
				...
				<div class="wow bounceInUp" data-wow-delay="1s">
					<div class="team boxed-grey">
						<div class="inner">
							...
							<div class="avatar">
								<img src="<%=path %>/img/team/4.jpg" alt=""
									class="img-responsive img-circle" />
							</div>
		...
		<div class="row">
				...
				<div class="wow fadeInLeft" data-wow-delay="0.2s">
					<div class="service-box">
						<div class="service-icon">
							<img src="<%=path %>/img/icons/service-icon-1.png" alt="" />
						</div>
			...
			<div class="col-md-3">
				<div class="wow fadeInUp" data-wow-delay="0.2s">
					<div class="service-box">
						<div class="service-icon">
							<img src="<%=path %>/img/icons/service-icon-2.png" alt="" />
						</div>
						<div class="service-desc">
							<h5>Web Design</h5>
							<p>Vestibulum tincidunt enim in pharetra malesuada. Duis
			...
			<div class="col-md-3">
				<div class="wow fadeInUp" data-wow-delay="0.2s">
					<div class="service-box">
						<div class="service-icon">
							<img src="<%=path %>/img/icons/service-icon-3.png" alt="" />
						</div>
						<div class="service-desc">
							<h5>Photography</h5>
							<p>Vestibulum tincidunt enim in pharetra malesuada. Duis
			...
			<div class="col-md-3">
				<div class="wow fadeInRight" data-wow-delay="0.2s">
					<div class="service-box">
						<div class="service-icon">
							<img src="<%=path %>/img/icons/service-icon-4.png" alt="" />
						</div>
						<div class="service-desc">
							<h5>Cloud System</h5>
							<p>Vestibulum tincidunt enim in pharetra malesuada. Duis
		...
		<div class="row">
			...
			<div class="col-lg-4">
				<div class="widget-contact">
					...
					<address>
						<strong>Squas Design, Inc.</strong><br> Tower 795 Folsom Ave,
						Beautiful Suite 600<br> San Francisco, CA 94107<br> <abbr
	...
	<script src="<%=path %>/contactform/contactform.js"></script>
